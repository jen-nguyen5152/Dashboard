...
### 4.1 What does the funding for Aboriginal and Torres Strait Islanders look like?
...
### 4.2 What are the most discussed aspects of Aboriginal and Torres Strait Islander that the government can focus on?
![image](https://github.com/user-attachments/assets/977c6172-6e18-45d7-b494-886dc64fa2b1)

I used WordCloud to show the frequency of each term, where it can easily be seen that some words are significantly more common than others. <b>People</b>, <b>government</b>, <b>woman</b> are the top 3 most frequent words in these articles.
- In the articles, the word <b>people</b> is used when referring to Aboriginal and Torres Strait Islanders as a whole, and also different "tribes" within this group, such as Gooniyandi people, Tjupan people, Dja Wurrung people, etc. It highlights that while the community can be referred to as "Indigenous Australians" as a whole, this is a multicultural community that every individual group should be respected and recognised.
- As mentioned above, the frequency of the word <b>government</b> indicates the significant role of governmental and political views in the Indigenous subject, especially in closing the cultural gap and building trust between communities and governments, as reported by the [Department of Prime Minister and Cabinet](https://www.niaa.gov.au/sites/default/files/reports/closing-the-gap-2017/executive-summary.html). Once again, this reflects the necessity of understanding and improving the impact of Advance Queensland programs to this cohort.
...
### 4.3 Are there any commercialisation opportunities for Aboriginal art and culture?
...
# 5. INSIGHTS
The purpose of this report is to further address some important questions about the Queensland funding situation, specifically for the Aboriginal and Torres Strait Islander community.  
